...
parser.add_argument('--config-path', type=str, default='ProgrammableRoom/diffusion_v2/configs/local_v15_cond3.yaml')
parser.add_argument('--learning-rate', type=float, default=1e-5)
parser.add_argument('---batch-size', type=int, default=2)
parser.add_argument('---training-steps', type=int, default=1e5)
parser.add_argument('---resume-path', type=str, default='ProgrammableRoom/diffusion_v2/ckpt/init_local_cond3.ckpt')
...
parser.add_argument('---num_local_conditions', type=int, default=3)
