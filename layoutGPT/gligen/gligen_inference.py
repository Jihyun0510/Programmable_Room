...
if __name__ == "__main__":
    ...
    parser.add_argument("-a1", "--alpha1", type=float, default=0.3)
    ...
    meta_list = [ 
        ...
        dict(
            ...
            prompt = "a teddy bear to the left of a bird",
        ...
        dict(
            ckpt = "gligen_checkpoints/checkpoint_generation_text.pth",
            prompt = "an elephant to the left of a cow",
            phrases = ['an elephant', 'a cow'],
            locations = [[0.1, 0.3, 0.4, 0.7], [0.45, 0.5, 0.8, 0.7]],
            alpha_type = [0.3, 0.0, 0.7],
            save_folder_name="checkpoint_generation_text_test0"
        ), 
